...
const { addproduct, findproductbyid,getallproducts,getuserproducts,getshopproducts,getProductByCategory,getProductBySubcategory,updateproduct, deleteproduct } = productControllers;
...
productRouter.get("/getProductBySubcategory/:name",getProductBySubcategory);
