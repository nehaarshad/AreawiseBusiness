...
class ManageSearchedProductsview extends ConsumerStatefulWidget {
   int id;
  String search;
  ManageSearchedProductsview({required this.id,required this.search});

  @override
  ConsumerState<ManageSearchedProductsview> createState() => _ManageSearchedProductsviewState();
}

class _ManageSearchedProductsviewState extends ConsumerState<ManageSearchedProductsview> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      ref.invalidate(searchProductViewModelProvider);
