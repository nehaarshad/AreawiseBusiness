      ...
      appBar: AppBar(
              actions: [
                Padding(
                  ...
                  child:IconButton(
                      onPressed:() {Navigator.pushNamed(context, routesName.sEditProduct,arguments: widget.product);},
                  ...
                  children: [
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: ()async{
                              await ref.read(cartViewModelProvider(widget.userid.toString()).notifier).addToCart(widget.userid.toString(),widget.product.id!);
                            },
                            child: Container(
                              width: 70,
                              height: 35,
                    ...
                    SizedBox(width: 5,),
                    Text("${widget.product.category?.name}", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.black),),
                    SizedBox(height: 10,),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Expanded(
                          child: Container(
                              child: Text("${widget.product.description}",style: TextStyle(fontWeight: FontWeight.bold,fontSize:15,color: Colors.grey),)
                          ),
                        ),
