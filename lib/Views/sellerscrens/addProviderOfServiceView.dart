...
class addProviderOfServiceView extends ConsumerStatefulWidget {
  final String serviceId;
  final String userId;
  const addProviderOfServiceView({super.key,required this.serviceId,required this.userId});

  @override
  ConsumerState<addProviderOfServiceView> createState() => _addProviderOfServiceViewState();
}

class _addProviderOfServiceViewState extends ConsumerState<addProviderOfServiceView> {
  @override
  Widget build(BuildContext context) {
    final state=ref.watch(addServiceProviderViewModelProvider(widget.userId));
   final model= ref.read(addServiceProviderViewModelProvider(widget.userId).notifier);
    return Scaffold(
      appBar: AppBar(
             ...
             child: Padding(
               ...
               child: Column(
                 ...
                 children: [
                   ...
                   setAreaDropDown(userid: widget.userId,),
                   Row(
                   ...
                   CustomButton(text: "Add Service", onPressed: ()async{
                     await ref.read(addServiceProviderViewModelProvider(widget.userId).notifier).addServiceProvider(userid: widget.userId,serviceid: widget.serviceId,context: context);
                  }),
                   InkWell(
                     onTap:()async{
