...
class _updateShopViewState extends ConsumerState<updateShopView> {
  ...
  void initState() {
    ...
    ref.read(updateShopProvider(widget.id.toString()).notifier).initValues(widget.id.toString()).then((_) {
