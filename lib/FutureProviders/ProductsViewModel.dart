...
final deleteProductProvider=FutureProvider.family<dynamic,String>((ref,id)async{
...
final getAllProductProvider=FutureProvider<List<ProductModel?>>((ref)async{
  List<ProductModel?> getallproducts=await ref.read(productProvider).getProduct();
  return getallproducts;
});

final getUserProductProvider=FutureProvider.family<List<ProductModel?>,String>((ref,id)async{
  List<ProductModel?> getuserproducts=await ref.read(productProvider).getUserProduct(id);
  return getuserproducts;
});

final getShopProductProvider=FutureProvider.family<List<ProductModel?>,String>((ref,id)async{
  List<ProductModel?> getshopproducts=await ref.read(productProvider).getShopProduct(id);
