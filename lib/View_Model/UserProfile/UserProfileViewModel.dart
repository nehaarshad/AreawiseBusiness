...
final UserProfileViewModelProvider=StateNotifierProvider.family<UserProfileViewModel, AsyncValue<UserDetailModel?>, String>((ref,id) {
...
class UserProfileViewModel extends StateNotifier<AsyncValue<UserDetailModel?>> {
  ...
  String getProfileImage(UserDetailModel? user) {
    String imageUrl= user?.image?.imageUrl != null && user!.image!.imageUrl!.isNotEmpty ? user.image!.imageUrl!
