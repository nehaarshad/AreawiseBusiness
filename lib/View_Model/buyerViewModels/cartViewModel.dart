...
final cartViewModelProvider=StateNotifierProvider.family<cartViewModel,AsyncValue<cartModel?>,String>((ref,id){
...
class cartViewModel extends StateNotifier<AsyncValue<cartModel?>>{
  ...
  Future<void> updateCartItem(String id,int data) async{
    try{
