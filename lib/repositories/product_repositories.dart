...
class ProductRepositories{
  ...
  Future<Map<String,dynamic>> addProduct(Map<String, dynamic> data,String id,List<File>? images) async{
    try{
  ...
  Future<ProductModel> FindProduct(String id) async{
    ...
    try{
      dynamic response=await apiservice.GetApiResponce(AppApis.GetProductByIDEndPoints.replaceFirst(':id', id));
  ...
  Future<List<ProductModel>> getUserProduct(String id) async{
    List<ProductModel> productlist=[];
    try{
      dynamic response=await apiservice.GetApiResponce(AppApis.GetUserProductsEndPoints.replaceFirst(':id', id));
      if (response is List){
        return response.map((products)=>ProductModel.fromJson(products as Map<String,dynamic>)).toList();
      }
      productlist=[ProductModel.fromJson(response)];
  ...
  Future<List<ProductModel>> getShopProduct(String id) async{
    List<ProductModel> productlist=[];
    try{
      dynamic response=await apiservice.GetApiResponce(AppApis.GetShopProductsEndPoints.replaceFirst(':id', id));
      if (response is List){
        return response.map((products)=>ProductModel.fromJson(products as Map<String,dynamic>)).toList();
      }
      productlist=[ProductModel.fromJson(response)];
  ...
  Future<Map<String,dynamic>> updateProduct(Map<String,dynamic> data,String id, List<File>? images) async{
    try{
      dynamic response=await apiservice.UpdateApiWithMultiport(AppApis.UpdateProductEndPoints.replaceFirst(':id', id), data,images);
      print(response);
      return response;
    }catch(e){
      throw e;
  ...
  Future<dynamic> deleteProduct(String id) async{
    try{
      dynamic response=await apiservice.DeleteApiResponce(AppApis.DeleteProductEndPoints.replaceFirst(':id', id));
      return response;
    }catch(e){
      throw e;
    }
